 ...
 */
$config['site_title']                 = "Alawi";       // Site Title, example.com This is not more functional
$config['admin_email']                = "ceo@adroitlight.com"; // Admin Email, admin@example.com This is not more functional
