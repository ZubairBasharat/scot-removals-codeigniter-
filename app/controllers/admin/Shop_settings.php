    ...
    function index() {
        ...
        if ($this->form_validation->run() == true) {
            ...
            $data = array('shop_name' => DEMO ? 'SMA Shop' : $this->input->post('shop_name'),
                'description' => DEMO ? 'Order App - SMA Shop - Demo Ecommerce Shop that would help you to sell your products from your site. Locked on demo.' : $this->input->post('description'),
