...
class Auth_model extends CI_Model{
    ...
    public function register($username, $password, $email, $additional_data = array(), $active = FALSE){
        ...
        $password_hash = $this->hash_password($password, $salt);
        ...
        $parse_data = array(
            'client_name' => $additional_data['name'],
            'site_link' => site_url(),
        ...
        $msg = file_get_contents('./themes/' . $this->Settings->theme . '/admin/views/email_templates/new_registration.html');
    ...
    public function login($identity, $password, $remember = FALSE)
    {
        ...
        $query = $this->db->select($this->identity_column . ', username, email, id, password, active, last_login, last_ip_address, avatar, gender, group_id, biller_id, company_id, view_right, edit_right, allow_discount, show_cost, show_price')
    ...
    public function login_remembered_user()
    {
        ...
        //get the user
        $this->trigger_events('extra_where');
        $query = $this->db->select($this->identity_column . ', id, username, email, last_login, last_ip_address, avatar, gender, group_id, biller_id, company_id, view_right, allow_discount, edit_right, show_cost, show_price')
    ...
    {
        $this->db->select($this->db->dbprefix('users') . '.id as id');
        $q = $this->db->get($this->db->dbprefix('users'));
