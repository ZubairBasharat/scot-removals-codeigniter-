           ...
           <form class="booking_details" method="post" action="<?php echo base_url('save_order'); ?>">
                    ...
                    <div class="d-inline-block w-100">
                        <div class="email_input adress_form row mx-0">
                            <div class="user-input-wrp col-12 px-0">
                                <input type="text" class="inputText focus_val_input order_validation border sys_val pr-3" autocomplete="off" data-id="focus_fname" name="booking_name" id="booking_name" required>
                                <span class="floating-label">First and Last Name</span>
                            </div>
                            <div class="user-input-wrp col-sm-6 pl-0 pr-0 pr-sm-3">
                                <input type="text" class="inputText focus_val_input text-lowercase order_validation border pr-3 focus_fname" autocomplete="off" data-id="focus_email" name="booking_email" id="booking_email" required>
                                <span class="floating-label">Email Address</span>
                            </div>
                            <div class="col-sm-6 px-0 target_ph_in">   
                                <div class="user-input-wrp d-flex  input-group-ph flex-wrap">
                                    <input type="number" class="position-relative inputText focus_val_input order_validation focus_email w-auto pr-3 booking_phone" data-id="at_delivery" name="booking_phone" id="booking_phone" required>
                            ...
                            <!-- <div class="position-relative mt-4 d-flex flex-wrap">
                                <label class="container_checkbox"> I am a bussiness customer
                                    <input type="checkbox" id="checkbox2" checked="checked">
                                    <span class="checkmark"></span>
                                </label>
                                <i class="fa fa-info-circle mt-1 text-primary ml-2" data-toggle="tooltip" data-placement="bottom" title="Type anything..."></i>
                            </div> -->
                        </div>
                    </div>
                </div> 
                    ...
                    <div class="d-inline-block w-100">
                        <div class="email_input adress_form row mx-0">
                                <div class="user-input-wrp mt-0 col-sm-5 pl-0 pr-0 pr-sm-3">
                                    <input type="text" class="inputText focus_val_input order_validation at_delivery border sys_val_post pr-3" data-id="post_cd" autocomplete="off" name="pickup_postal" id="pickup_postal" required>
                                ...
                                <div class="user-input-wrp col-sm-5 pl-0 pr-0 pr-sm-3">
                                    <input type="text" autocomplete="off" class="inputText order_validation focus_val_input border sys_val pr-3 post_cd" data-id="ph_pick" autocomplete="off" name="pickup_name" id="pickup_name" required>
                                    <span class="floating-label">Contact Name at Pickup</span>
                                </div>
                                <div class="col-sm-7 px-0 target_ph_in">   
                                    <div class="user-input-wrp d-flex input-group-ph flex-wrap">
                                        <input type="number" class="position-relative inputText order_validation focus_val_input_validation w-auto pr-3 ph_pick focus_val_input pickup_phone" data-id="pn_pick" name="pickup_phone" id="pickup_phone" required>
                                ...
                                <!-- <div class="position-relative mt-4 d-flex flex-wrap">
                                    <label class="container_checkbox"> Use my Contact Details.
                                        <input type="checkbox" id="checkbox2" checked="checked">
                                        <span class="checkmark"></span>
                                    </label>
                                    <i class="fa fa-info-circle mt-1 text-primary ml-2" data-toggle="tooltip" data-placement="bottom" title="Type anything..."></i>
                ...
                <div class="bg-white p-xl-5 p-3 bg_drop my-4">
                    ...
                    <div class="d-inline-block w-100">
                        <div class="email_input adress_form row mx-0">
                            <div class="user-input-wrp mt-0 col-sm-5 pl-0 pr-0 pr-sm-3">
                                <input type="text" class="inputText order_validation border focus_val_input sys_val_post pr-3 pn_pick" data-id="cn_del" autocomplete="off" name="delivery_postal" id="delivery_postal" required>
                            ...
                            <div class="user-input-wrp col-sm-5 pl-0 pr-0 pr-sm-3">
                                <input type="text" class="inputText order_validation focus_val_input border sys_val pr-3 cn_del" data-id="ph_ppc" name="delivery_name" autocomplete="off" id="delivery_name" required>
                                <span class="floating-label">Contact Name at Delivery</span>
                            </div>
                            <div class="col-sm-7 px-0 target_ph_in">
                                <div class="user-input-wrp d-flex input-group-ph flex-wrap">
                                    <input type="number" class="position-relative inputText order_validation ph_ppc focus_val_input w-auto pr-3 drop_phone"  name="delivery_phone" id="delivery_phone" required>
                                    <span class="floating-label">Phone Number at Delivery</span>
                                    <button class="trigger_ph_in fa fa-plus position-absolute add-phone-num-btn" type="button"></button>
                                </div>
                            </div>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content bg-white">
                    <div class="new-modal-h mt-4 mb-3">
                        ...
                        <p class="text-center mb-0 scot-blue">We are not save your payment details</p>
                    </div>
                    <div  data-toggle="modal" data-target="#" onclick="pay('<?php echo !empty($storage) ? number_format($storage->total, 2) : 0.00; ?>')" class="" id="payment_popup_opener" data-dismiss="modal">
                        <div class="row">
                            <div class="mx-auto col-7 px-0 py-0 d-flex justify-content-center shadow-sm mb-4 payment-method-logo">
                                <!-- <img src="<?php echo base_url();?>assets/images/paypal2.png" class="img-fluid" style="width: 130px;"> -->
   ...
   $('#pickup').prop('disabled', true);
    ...
    var input_status = 0;
       ...
       $(document).ready(function(){
        ...
        //     $(".tabs_sec .counter-body").append('<div class="items_counter mb-1px" data-id='+localStorage.getItem('piano_id')+'><div class="item_catagory"><div class="item_catagory_inner" data-id='+localStorage.getItem('piano_id')+'><p data-id = "data-id='+localStorage.getItem('piano_id')+'">'+ localStorage.getItem("piano_nam") +'</p></div><div class="add_counter h-100" style="top:0px;right:0px;"><ul class="mb-0 h-100 d-flex mr-2 align-center" data-item="1" data-id="1"><li><button class="fa fa-minus item_catagory_minus" onclick="subtract_qty()"></button></li><li class="h-100 d-flex align-center"><input class="item_catagory_value" type="number" readonly value="1" data-item="'+localStorage.getItem('piano_id')+'"  onchange="chnage_quantity()" ></li><li><button class="fa fa-plus item_catagory_plus" onclick="add_qty()"></button></li></ul></div></div></div>');
        // }
        // }
        ...
        //         $('.first_row').remove();
        //         $(".tabs_sec .counter-body").append('<div class="items_counter mb-1px" data-id='+furniture[counter].id+'><div class="item_catagory"><div class="item_catagory_inner" data-id='+furniture[counter].id+'><p data-id = "data-id='+furniture[counter].id+'">'+ furniture[counter].name +'</p></div><div class="add_counter h-100" style="top:0px;right:0px;"><ul class="mb-0 h-100 d-flex mr-2 align-center" data-item="1" data-id="1"><li><button class="fa fa-minus item_catagory_minus" onclick="subtract_qty()"></button></li><li class="h-100 d-flex align-center"><input class="item_catagory_value'+furniture[counter].id+'" type="number" readonly value="'+furniture[counter].quantity+'" data-item="1"  onchange="chnage_quantity()" ></li><li><button class="fa fa-plus item_catagory_plus" onclick="add_qty()"></button></li></ul></div></div></div>');
        //         counter++;
        //     });
        // }
        // }
        ...
        //         $('.first_row').remove();
        //         $(".tabs_sec .counter-body").append('<div class="items_counter mb-1px" data-id='+office[office_counter].id+'><div class="item_catagory"><div class="item_catagory_inner" data-id='+office[office_counter].id+'><p data-id = "data-id='+office[office_counter].id+'">'+ office[office_counter].name +'</p></div><div class="add_counter h-100" style="top:0px;right:0px;"><ul class="mb-0 h-100 d-flex mr-2 align-center" data-item="1" data-id="1"><li><button class="fa fa-minus item_catagory_minus" onclick="subtract_qty()"></button></li><li class="h-100 d-flex align-center"><input class="item_catagory_value'+office[counter].id+'" type="number" readonly value="'+office[counter].quantity+'" data-item="1"  onchange="chnage_quantity()" ></li><li><button class="fa fa-plus item_catagory_plus" onclick="add_qty()"></button></li></ul></div></div></div>');
        //         office_counter++;
        //     });
        // }
        // }
        ...
        //         $('.first_row').remove();
        //         $(".tabs_sec .counter-body").append('<div class="items_counter mb-1px" data-id='+home[home_counter].id+'><div class="item_catagory"><div class="item_catagory_inner" data-id='+home[home_counter].id+'><p data-id = "data-id='+home[home_counter].id+'">'+home[home_counter].name+'</p></div><div class="add_counter h-100" style="top:0px;right:0px;"><ul class="mb-0 h-100 d-flex mr-2 align-center" data-item="1" data-id="1"><li><button class="fa fa-minus item_catagory_minus" onclick="subtract_qty()"></button></li><li class="h-100 d-flex align-center"><input class="item_catagory_value'+home[counter].id+'" type="number" readonly value="'+home[counter].quantity+'" data-item="1"  onchange="chnage_quantity()" ></li><li><button class="fa fa-plus item_catagory_plus" onclick="add_qty()"></button></li></ul></div></div></div>');
        //         home_counter++;
        //     });
        // }
        // } 
  ...
  function stripeResponseHandler(status, response) {
    ...
    function save_order(){
        ...
        if(input_status >=9){
            ...
            if (!regex_email.test(booking_email)) {
                ...
                // alert('Pickup Details: name='+pickup_name+' postal = '+pickup_postal+' phone = '+pickup_phone);
                $.ajax({
                    type: "GET",
                    url: '<?php echo base_url('save_order'); ?>',
                    dataType: 'json',
                    data: {'storage_id':storage_id,'order_date':order_date,'order_persons':order_persons,'booking_name': booking_name, 'booking_email': booking_email,'booking_phone': booking_phone, 'pickup_postal': pickup_postal,'pickup_name': pickup_name, 'pickup_phone': pickup_phone,'delivery_postal': delivery_postal, 'delivery_name': delivery_name, 'delivery_phone':delivery_phone , "start_time": start_time , "end_time": end_time},
    ...
    <script>
        ...
        onAuthorize: function (data, actions) {
            ...
            .then(function () {
                window.location = "<?php echo $return_url;?>?paymentID="+data.paymentID+"&payerID="+data.payerID+"&token="+data.paymentToken+"&sid=<?php echo $storage_id; ?>";
            });
        }
        }, '#paypal-button');
//         function add_qty(id)
  ...
  <script type="text/javascript">
    ...
    function pay(amount) {
      ...
      var handler = StripeCheckout.configure({
        key: 'pk_test_51HHYGuGPIBNgvAvHFvBiXmFFPMTfEppx2qxWYTewg9cMWxOGuyvknQTdOo2MvrtVfEjvlxkhchGQ5BUUcCHjldAO00QwyXrkpY',
        locale: 'auto',
        currency: 'EUR',
        ...
        //   alert(token);
          $.ajax({
            url:"<?php echo base_url('shop/stripePost'); ?>",
            data: { stripeToken: token.id, amount: amount , storage_id : storage_id },
            success: function( response ) {
                window.location.replace("<?= base_url('shop/order_success/') ?>"+response);
                // alert('response');
