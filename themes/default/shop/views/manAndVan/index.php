      ...
      <div class="row m-0">
         <div class="col-lg-8 col-md-6 pr-md-4 pl-0 wow slideInLeft pr-0" data-wow-duration="1.5s">
            <div class="bg-white p-xl-5 p-3 bg_drop px-sm-10">
               <div class="banner_inner_text p-0 mt-1">
                  <h3 class="mb-0"><span class="circle_icon position-change-i"></span>Get an accurate quote in just 3 mins!</h3>
               ...
               <div class="banner_inner_form m-0">
                  <form class="row w-100 m-0">
                     <div class="col-md-6 pr-sm-2 pr-0 pl-0">
                        <!-- Dropdown 1 Start -->
                              ...
                              <div class="dropdown_content inc_width catagory1">
                                 <div class="row m-0 text-center content_list_view">
                                    ...
                                    <div class="col-sm-4 content_col ">
                                       <h3><span  class="<?=$c->category_font?>"></span></h3>
                                       <ul class="p-0 mt-3 content_detail_list">
                                          ...
                                          <li class="<?php if($p->lift_option == "Yes"){echo 'open_inner_dropdown';}else{echo 'not_open_dropdown';} ?>">
                                             <span data-id="<?=$p->id?>" data-slug="<?=$p->slug?>"><?=$p->name?></span>
                                          </li>
                                          <?php } } ?>
                                       </ul>
                                    </div>
                        ...
                        <!-- <div class="w-100 main_drop_aria dop4" id="open_drop_li_click" style="display:none;">
                           <div class="form_input drop_btn" id="catagory_inner2">
                              <span class="btn_selected_text" data-id="5" data-slug="ground" >Ground Floor</span>
                              <span class="fa fa-angle-down float-right mr-3 toggle_icon"></span>
                           </div>
                           <div class="dropdown_list">
                     ...
                     <div class="col-md-6 pr-sm-2 pl-0 pr-0 pl-md-2">
                        <!-- Dropdown Start 2-->
                     ...
                     <div class="instance_btn w-100 mr-sm-2 mr-0 mt-1 position-relative">
                        <button class="price_btn w-100 border-0" id="complete_quote" href="#" onclick="man_and_van_order_details()">
                          Complete My Quote
                        </button>
...
// }
   ...
   function man_and_van_order_details(){
      ...
      //   localStorage.setItem("drop",$("#drop").val());
        if(pickup != ""){
           if(drop != ""){
            ...
            dataType: 'json',
            data: {'pickup': pickup, 'drop': drop,'storage_id': "<?= $storage_id ?>", 'slug': 'ground_to_ground', 'type': 'man_and_van'},           
            beforeSend: function() {
               $('.button-spinner').show();
            ...
            success: function(data) {
               $('.button-spinner').hide();
               window.location.href = '<?= base_url('shop/man_and_van/details/');?>'+data;
            },
