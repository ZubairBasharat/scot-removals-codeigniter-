            ...
            <div class="bg-white p-xl-5 p-3 bg_drop px-sm-10">
               ...
               <div class="banner_inner_form m-0">
                  <form class="row w-100 m-0">
                     <div class="col-md-6 pr-md-2 pr-0 pl-0">
                     ...
                     <div class="col-md-6 pl-0 pl-md-2 pr-0 mt-1">
                     ...
                     <div class="col-md-6 pl-0 pr-0 pl-md-2 mt-1">
                        ...
                        <div class="w-100 main_drop_aria dop3" id="open_drop_li_click2">
                           ...
                           <div class="dropdown_list">
                              <div class="dropdown_content catagory_inner3">
                                 <div class="row m-0 text-center content_list_view">
                                    <div class="col-12 content_col ">
                                       <img src="<?php echo base_url()?>assets/images/home2.svg" class="icon2">
                                       <ul class="p-0 mt-3 content_detail_list">
                                          <?php foreach ($floors as $f) { ?>
                     ...
                     <div class="instance_btn w-100 position-relative">
                        <button class="price_btn w-100 border-0 text-capitalize" id="complete_quote2" type="button" onclick="furniture_order_details()">
                          view my price
                        </button>
...
// }
   ...
   function furniture_order_details(){
      if($("#pickup").val()=="")
      {
         swal(
            'Empty',
      ...
      // localStorage.setItem("drop",$("#drop").val());
       ...
       // window.location.href = '<?= base_url('shop/furniture_delivery/details');?>';
       var slug1 = "ground";
       ...
       $.ajax({
           ...
           dataType: 'json',
           data: {'slug': slug, 'type': "furniture_delivery",'pickup': pickup, 'drop': drop , 'storage_id': "<?= $storage_id?>"},
            beforeSend: function() {
               $('.button-spinner').show();
           ...
           success: function(data) {
            $('.button-spinner').hide();
               window.location.href = '<?= base_url('shop/furniture_delivery/details/');?>'+data;
           },
