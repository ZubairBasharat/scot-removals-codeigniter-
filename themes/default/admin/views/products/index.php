...
<script>
    ...
    $(document).ready(function () {
        oTable = $('#PRData').dataTable({
            ...
            "aoColumns": [
                {"bSortable": false, "mRender": checkbox}, {"bSortable": false,"mRender": img_hl}, null, null, null, {"mRender": <?= $Settings->quick_price_update ? 'formatDecimalsCurrencyModal' : 'formatDecimalsCurrency' ?>}, {"bSortable": false}
            ]
                ...
                <div class="table-responsive">
                    <table id="PRData" class="table table-bordered table-condensed table-hover table-striped">
                        ...
                        <tr class="primary">
                            ...
                            <th><?= lang("code") ?></th>
                            <th style="min-width:200px; width: 200px; text-align: center;"><?= lang("name") ?></th>
                            <th><?= lang("category") ?></th>
                            <th><?= lang("price") ?></th>
                        ...
                        <tr class="active">
                            ...
                            <th style="min-width:40px; width: 40px; text-align: center;"><?php echo $this->lang->line("image"); ?></th>
                            <th></th>
                            <th style="min-width:200px; width: 200px; text-align: center;"></th>
                            <th></th>
                            <th></th>
