...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-plus"></i><?= lang('man_and_van'); ?></h2>
    </div>
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo admin_form_open_multipart("products/man_and_van", $attrib)
                ?>
    ...
    <div class="modal-dialog" style="width: 900px;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input type="hidden" id="action" name="action" value="man_and_van">
            ...
            success: function(data) {
                if(data[0].id != 0){
                    if(type == "product"){
                        ...
                        if(purpose == "edit"){
                            $("#product_form").attr('action', '<?= base_url('admin/products/man_and_van_edit/') ?>'+data[0].id);
                            $(".btn-product").val('Edit Product');
                        }else{
                            $("#product_form").attr('action', '<?= base_url('admin/products/man_and_van') ?>');
                        ...
                        if(purpose == "edit"){
                            $("#sub_product_form").attr('action', '<?= base_url('admin/products/man_and_van_edit/') ?>'+data[0].id);
                            $(".btn-sub-product").val('Edit Product');
                        }else{
                            $("#sub_product_form").attr('action', '<?= base_url('admin/products/man_and_van') ?>');
