                ...
                <div class="col-md-5">
                    ...
                    foreach($languages as $lang => $val){ 
                        if($lang != "english"){  ?>
                            ...
                            <div class="form-group all">
                                <label> <?= lang('product_name', 'name'); ?> <img src="<?php echo ALS_LANGUAGE_IMAGES.$lang.".png"?>" height="20" alt="" />&nbsp;<?php echo $val['name'];?></label>
                                <input type="text" name='<?php echo "translated[$lang][name]"; ?>' class="form-control" value="" >
                            </div>
                            ...
                            <div class="form-group all">
                                ...
                                <textarea type="text" name='<?php echo "translated[$lang][product_details]"; ?>' class="form-control" value="" ></textarea>
                            ...
                            <div class="form-group all">
                                ...
                                <textarea type="text" name='<?php echo "translated[$lang][details]"; ?>' class="form-control" value="" ></textarea>
                            </div>
                        <?php 
                        } 
                    } ?>
