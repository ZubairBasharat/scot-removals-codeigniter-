...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-plus"></i><?= lang('piano_transport'); ?></h2>
    </div>
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                <?php
                $attrib = array('data-toggle' => 'validator', 'role' => 'form', 'id' => 'piano_form');
                echo admin_form_open_multipart("products/piano_transport", $attrib)
                ?>
    ...
    <div class="modal-dialog" style="width: 900px;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input type="hidden" id="action" name="action" value="piano_transport">
...
<script type="text/javascript">
    $(document).ready(function () {
        $(".toggle-popover-c").popover({
            html: true,
            placement: 'left',
            content: `<p>Are you sure?</p><a class='btn btn-danger po-delete11' id='a__8' href='<?php echo base_url("admin/products/deletePiano/"); ?>'>Yes I'm sure</a> <button class='btn po-close'>No</button>`
        });
        ...
        $.ajax({
            ...
            success: function(data) {
                if(data[0].id != 0){
                    ...
                    if(purpose == "edit"){
                        $("#piano_form").attr('action', '<?= base_url('admin/products/piano_transport_edit/') ?>'+data[0].id);
                        $(".btn-product").val('Edit Product');
                    }else{
                        $("#piano_form").attr('action', '<?= base_url('admin/products/piano_transport') ?>');
