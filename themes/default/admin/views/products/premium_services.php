...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-plus"></i><?= lang('premium_services'); ?></h2>
    </div>
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo admin_form_open_multipart("products/extra_services", $attrib)
                ?>
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group all" style="width: 96.5%;">
        ...
        <?php 
            ...
            <div class="row m-0">
                <div class="col-md-4" style="margin-top:20px;">
                    ...
                    <div class="form-group all">
                        <label for="sub_product_name">Product Name</label>
                        <?= form_input('sub_product_name', "", 'class="form-control" id="sub_product_name" required="required"'); ?>
                    </div>
                
                    <div class="form-group all">
                        <label for="sub_product_price">Premium Price Ground To Ground</label>
                        <?= form_input('g_t_g', "", 'class="form-control tip" id="g_t_g" required="required"') ?>
                    </div>
                    <div class="form-group all">
                        <label for="sub_product_price">Premium Price Ground To 1st Floor</label>
                        <?= form_input('g_t_first', "", 'class="form-control tip" id="g_t_first" required="required"') ?>
                    </div>
                    <div class="form-group all">
                        <label for="sub_product_price">Premium Price Ground To 2nd Floor</label>
                        <?= form_input('g_t_second', "", 'class="form-control tip" id="g_t_second" required="required"') ?>
                    </div>
                    <div class="form-group all">
                        <label for="sub_product_price">Premium Price Ground To 3rd Floor</label>
                        <?= form_input('g_t_third', "", 'class="form-control tip" id="g_t_third" required="required"') ?>
                    </div>
                    <div class="form-group all">
                        <label for="sub_product_price">Premium Price Ground To 4th Floor</label>
                        <?= form_input('g_t_fourth', "", 'class="form-control tip" id="g_t_fourth" required="required"') ?>
                    </div>
                    <!-- <div class="form-group all" style="text-align: right;">
                        <a href="javascript:void(0)" class="btn btn-info"> <i class="fa fa-plus"></i> Add Prices</a>
                    </div> -->
                    <div class="form-group">
                                    ...
                                    <?php foreach ($sub_products as $p) { ?>
                                        <tr>
                                            ...
                                            <td style="text-align: left">
                                                ...
                                                <?php //} ?>
                                                <?=$this->sma->formatDecimal($p->price)?>
                                            </td>
                                            <td style="text-align: center">
                                                <div class="text-center">
                                                    <div class="btn-group text-left"><button type="button" class="btn btn-default btn-xs btn-primary dropdown-toggle" data-toggle="dropdown">Actions <span class="caret"></span></button>
                                                        <ul class="dropdown-menu pull-right" role="menu">
                                                            ...
                                                            <li><a href="javascript:void(0)" onclick = "fill_values('<?=$p->id?>', 'sub_product', 'edit');" ><i class="fa fa-edit"></i> Add to Premium</a></li><li class="divider"></li>
                                                            <!-- <li data-id="<?=$p->id?>"><a href="#" class="tip po toggle-popover-c" title=""  rel="popover" data-original-title="Delete Sub Product"><i class="fa fa-trash-o"></i> Delete Sub Product</a></li> -->
                                                        </ul>
                                                    </div>
                                                </div>
                                            </td>
    ...
    <div class="modal-dialog" style="width: 900px;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input type="hidden" id="action" name="action" value="extra_services">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $(".toggle-popover-c").popover({
            html: true,
            placement: 'left',
            content: `<p>Are you sure?</p><a class='btn btn-danger po-delete11' id='a__8' href='<?php echo base_url("admin/products/delete/"); ?>'>Yes I'm sure</a> <button class='btn po-close'>No</button>`
        });
            ...
            success: function(data) {
                if(data[0].id != 0){
                    if(type == "product"){
                        ...
                        if(purpose == "edit"){
                            $("#product_form").attr('action', '<?= base_url('admin/products/add_to_premium/') ?>'+data[0].id);
                            $(".btn-product").val('Edit Product');
                        }else{
                            $("#product_form").attr('action', '<?= base_url('admin/products/extra_services') ?>');
                        ...
                        if(purpose == "edit"){
                            $("#sub_product_form").attr('action', '<?= base_url('admin/products/add_to_premium/') ?>'+data[0].id);
                            $(".btn-sub-product").val('Edit Product');
                        }else{
                            $("#sub_product_form").attr('action', '<?= base_url('admin/products/extra_services') ?>');
