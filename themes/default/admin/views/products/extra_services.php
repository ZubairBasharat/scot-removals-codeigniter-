...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-plus"></i><?= lang('extra_services'); ?></h2>
    </div>
            ...
            success: function(data) {
                if(data[0].id != 0){
                    if(type == "product"){
                        ...
                        if(purpose == "edit"){
                            $("#product_form").attr('action', '<?= base_url('admin/products/extra_services_edit/') ?>'+data[0].id);
                        ...
                        if(purpose == "edit"){
                            $("#sub_product_form").attr('action', '<?= base_url('admin/products/extra_services_edit/') ?>'+data[0].id);
