...
<script type="text/javascript">
    var count = 1, an = 1, product_variant = 0, DT = 0,
        product_tax = 0, total_discount = 0, total = 0, allow_discount = <?= ($Owner || $Admin || $this->session->userdata('allow_discount')) ? 1 : 0; ?>;
                    ...
                    <div class="col-lg-12">
                                ...
                                <div class="controls table-controls">
                                    <table id="slTable"
                                        ...
                                        <tr>
                                            ...
                                            <?php if ($Settings->product_discount && ($Owner || $Admin || $this->session->userdata('allow_discount') || $inv->product_discount)) {
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <?php echo form_input('shipping', '', 'class="form-control input-tip" id="slshipping" readonly'); ?>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <?php $sst = array('pending' => lang('pending'), 'completed' => lang('completed'), 'cancel' => lang('cancel'));
