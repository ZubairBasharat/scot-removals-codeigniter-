...
<?php if ($Owner || $Admin) { ?>
    <ul id="myTab" class="nav nav-tabs">
        <li class=""><a href="#details" class="tab-grey"><?= lang('floor_details') ?></a></li>
    </ul>
...
<div class="tab-content">
    <div id="details" class="tab-pane fade in">
        ...
        <div class="box">
            <div class="box-header">
                <h2 class="blue"><i class="fa-fw fa fa-file-text-o nb"></i> <?= $floor->name.(SHOP && $floor->hide != 1 ? ' ('.lang('shop_views').': '.$floor->views.')' : ''); ?></h2>
                    ...
                    <ul class="btn-tasks">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu pull-right tasks-menus" role="menu"
                                ...
                                <li>
                                    <a href="<?= admin_url('floors/edit/' . $floor->id) ?>">
                                        <i class="fa fa-edit"></i> <?= lang('edit') ?>
                                    </a>
                                </li>
                                <!-- <li>
                                    <a href="<?= admin_url('floors/pdf/' . $floor->id) ?>">
                                        <i class="fa fa-download"></i> <?= lang('pdf') ?>
                                    </a>
                                </li> -->
                                <li class="divider"></li>
                                <li>
                                    <a href="#" class="bpo" title="<b><?= lang("delete_floor") ?></b>"
            ...
            <div class="box-content">
                <div class="row">
                    <div class="col-lg-12">
                        <p class="introtext"><?php echo lang('floor_details'); ?></p>
                        <div class="row">
                            <div class="col-sm-5">
    ...
    <div id="sales" class="tab-pane fade">
        <script type="text/javascript">
            $(document).ready(function () {
                oTable = $('#SlRData').dataTable({
                    ...
                    'sAjaxSource': '<?= admin_url('reports/getSalesReport/?v=1&floor='.$floor->id) ?>',
        ...
        <div class="box">
            <div class="box-header">
                <h2 class="blue"><i class="fa-fw fa fa-heart nb"></i><?= $floor->name . ' ' . lang('sales'); ?></h2>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#pdf').click(function (event) {
                ...
                window.location.href = "<?=admin_url('reports/getSalesReport/pdf/?v=1&floor='.$floor->id)?>";
                return false;
            });
            $('#xls').click(function (event) {
                event.preventDefault();
                window.location.href = "<?=admin_url('reports/getSalesReport/0/xls/?v=1&floor='.$floor->id)?>";
                return false;
            });
