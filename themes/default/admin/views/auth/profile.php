                                    ...
                                    <div class="col-md-12">
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <?php echo form_input('name', $user->name, 'class="form-control" id="name" required="required"'); ?>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <?php echo form_input('username', $user->username, 'class="form-control" id="username" required="required"'); ?>
                                                </div>
                                            </div>
