                        ...
                        if ($Owner || $Admin) {
                            ...
                            <li class="mm_products">
                                ...
                                <ul>
                                    ...
                                    <li id="furniture_delivery">
                                        <a class="submenu" href="<?= admin_url('products/furniture_delivery'); ?>">
                                            <i class="fa fa-plus-circle"></i>
                                            <span class="text"> <?= lang('furniture_delivery'); ?></span>
                                        </a>
                                    </li>
                                    <li id="house_removals">
                                        <a class="submenu" href="<?= admin_url('products/house_removals'); ?>">
                                            <i class="fa fa-plus-circle"></i>
                                            <span class="text"> <?= lang('house_removals'); ?></span>
                                        </a>
                                    </li>
                                    <li id="office_removals">
                                        <a class="submenu" href="<?= admin_url('products/office_removals'); ?>">
                                            <i class="fa fa-plus-circle"></i>
                                            <span class="text"> <?= lang('office_removals'); ?></span>
                                        </a>
                                    </li>
                                    <li id="man_and_van">
                                        <a class="submenu" href="<?= admin_url('products/man_and_van'); ?>">
                                            <i class="fa fa-plus-circle"></i>
                                            <span class="text"> <?= lang('man_and_van'); ?></span>
                                        </a>
                                    </li>
                                    <!-- <li id="man_power_only">
                                        <a class="submenu" href="<?= admin_url('products/man_power_only'); ?>">
                                            <i class="fa fa-plus-circle"></i>
                                            <span class="text"> <?= lang('man_power_only'); ?></span>
                                        </a>
                                    </li> -->
                                    <li id="piano_transport">
                                        <a class="submenu" href="<?= admin_url('products/piano_transport'); ?>">
                                            <i class="fa fa-plus-circle"></i>
                                            <span class="text"> <?= lang('piano_transport'); ?></span>
                                        </a>
                                    </li>
                                    <li id="extra_services">
                                        <a class="submenu" href="<?= admin_url('products/extra_services'); ?>">
                                            <i class="fa fa-plus-circle"></i>
                                            <span class="text"> <?= lang('extra_services'); ?></span>
                                        </a>
                                    </li>
                                    <li id="extra_services">
                                        <a class="submenu" href="<?= admin_url('products/premium_services'); ?>">
                                            <i class="fa fa-plus-circle"></i>
                                            <span class="text"> <?= lang('Premium_Services'); ?></span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li class="mm_order">
                                ...
                                <ul>
                                    <li id="orders_index">
                                        <a class="submenu" href="<?= admin_url('orders'); ?>">
                                            <i class="fa fa-shopping-cart"></i>
                                            <span class="text"> <?= lang('list_orders'); ?></span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li class="mm_floor">
                                <a class="dropmenu" href="#">
                                    <i class="fa fa-barcode"></i>
                                    <span class="text"> <?= lang('floors'); ?> </span>
                                    <span class="chevron closed"></span>
                                </a>
                                <ul>
                                    <li id="floors_index">
                                        <a class="submenu" href="<?= admin_url('floors'); ?>">
                                            <i class="fa fa-barcode"></i>
                                            <span class="text"> <?= lang('list_floors'); ?></span>
                                        </a>
                                    </li>
                                    <li id="floors_add">
                                        <a class="submenu" href="<?= admin_url('floors/add'); ?>">
                                            <i class="fa fa-plus-circle"></i>
                                            <span class="text"> <?= lang('add_floor'); ?></span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li class="mm_auth mm_customers mm_suppliers mm_billers">
                                ...
                                <ul>
                                    ...
                                    <li id="customers_index">
                                        <a class="submenu" <?php if($count2 <= 50){ ?> href="<?= admin_url('customers/add'); ?>" data-toggle="modal" data-target="#myModal" <?php }else{ ?> onclick="alert('You cannot add more than 50 customers please contact to administrator!');" <?php } ?> >
                            ...
                            <?php } ?>
                            <li class="mm_reports" style="display:none;">
                                <a class="dropmenu" href="#">
                            ...
                            <li class="mm_shop_settings mm_api_settings" style="display:none;">
                                <a class="dropmenu" href="#">
