    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            foreach($languages as $lang => $val){ 
                if($lang != "english"){ @$trans = getCategoriesTranslation($lang, $category->id); ?>
                    <div class="form-group all">
                        <label  class="control-label text-left"> <?= lang('category_name', 'name'); ?> <img src="<?php echo ALS_LANGUAGE_IMAGES.$lang.".png"?>" height="20" alt="" />&nbsp;<?php echo $val['name'];?></label>
                        <input type="text" name='<?php echo "translated[$lang][name]"; ?>' class="form-control" placeholder="Name" value="<?php echo @$trans[0]->trans_name;?>" >

                        <label  class="control-label text-left"> <?= lang('description', 'description'); ?> <img src="<?php echo ALS_LANGUAGE_IMAGES.$lang.".png"?>" height="20" alt="" />&nbsp;<?php echo $val['name'];?></label>
                        <input type="text" name='<?php echo "translated[$lang][description]"; ?>' class="form-control" placeholder="Description" value="<?php echo @$trans[0]->trans_description;?>" >
                    </div>
                <?php 
                } 
            } ?>
